      ...
      <div class="row">
        <div class="col-12">
          <nav class="main-nav">
            ...
            <!-- ***** Menu Start ***** -->
            <ul class="nav">
              <li><a href="memberevent.php" class="active">Public Events</a></li>
             
             
              <li><a href="#" style="color: green; font-weight: bold;" onclick="showAlert()">Request</a></li>

                <script>
                function showAlert() {
                    alert("You are not allowed to request. You are logging in as a guest. Please verify first.");
                }
                </script>


              <li><div class="border-first-button"><a href="guesthome.php">Back to Home</a></div></li> 
...
<body>
    <div class="container">
		...
		<div class="row">
			...
			$sql = "SELECT * FROM tbl_event WHERE `event-covered` = 'open-for-all'";
