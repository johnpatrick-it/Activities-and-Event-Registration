        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li><a href="memevent_sports.php" >Sports</a></li>
              <li><a href="memevent_comservice.php" class="active">Community Service</a></li>
...
<body>
    <div class="container">
		...
		<div class="row">
			...
			$sql = "SELECT * FROM tbl_event WHERE event_Type = 'Community Service'";
